...
var FILAS_SEMILLA_TABLA_PARAMETRICA_ECONOMICA = [
  ...
  ["SI", 130, "CONTIENE", "LA LISTA ESTA SIN CERRAR", "LISTA_SIN_CERRAR", "Lista sin cerrar", "Se ha identificado un caso de lista sin cerrar", "Se han identificado {{cantidad}} casos de lista sin cerrar", "En analisis.", "SI", ""],
  ["SI", 140, "CONTIENE", "IMPORTES A NULO", "IMPORTES_NULOS", "Importes nulos o a cero", "Se ha identificado una incidencia por importes nulos o a cero", "Se han identificado {{cantidad}} incidencias por importes nulos o a cero", "En analisis.", "SI", "Agrupa importes a nulo"],
  ["SI", 140, "CONTIENE", "IMPORTES A 0", "IMPORTES_NULOS", "Importes nulos o a cero", "Se ha identificado una incidencia por importes nulos o a cero", "Se han identificado {{cantidad}} incidencias por importes nulos o a cero", "En analisis.", "SI", "Agrupa importes a 0"],
  ["SI", 150, "CONTIENE", "DESCUADRE DE IMPORTES", "DESCUADRE_IMPORTES", "Descuadre de importes", "Se ha identificado un error por descuadre de importes", "Se han identificado {{cantidad}} errores por descuadre de importes", "En analisis.", "SI", ""],
  ["SI", 150, "CONTIENE", "IMPORTE FACTURA DESCUADRA", "DESCUADRE_IMPORTES", "Descuadre de importes", "Se ha identificado un error por descuadre de importes", "Se han identificado {{cantidad}} errores por descuadre de importes", "En analisis.", "SI", ""],
  ["SI", 160, "CONTIENE", "TASAS", "ERRORES_TASAS", "Errores en liquidacion de tasas", "Se ha identificado un error en liquidacion/impuesto de tasas", "Se han identificado {{cantidad}} errores en liquidacion/impuesto de tasas", "En analisis.", "SI", "Agrupa todos los errores que mencionan TASAS"],
  ["SI", 170, "CONTIENE", "COD_ENTIDAD_EMI NULO", "ENTIDAD_EMI_NULO", "Codigo de entidad emisora nulo", "Se ha identificado un error por codigo de entidad emisora nulo", "Se han identificado {{cantidad}} errores por codigo de entidad emisora nulo", "En analisis.", "SI", ""],
  ["SI", 180, "CONTIENE", "TRASPASO ENTRE CUENTAS CON IMPORTE DISTINTO DE 0", "TRASPASO_IMPORTE_NO_CERO", "Traspaso entre cuentas con importe distinto de cero", "Se ha identificado un error por traspaso entre cuentas con importe distinto de cero", "Se han identificado {{cantidad}} errores por traspaso entre cuentas con importe distinto de cero", "En analisis.", "SI", ""],
  ["SI", 190, "CONTIENE", "ERRORES EN COMUNICACION CON TRON", "COMUNICACION_TRON", "Error de comunicacion con TRON", "Se ha identificado una incidencia de comunicacion con el sistema TRON", "Se han identificado {{cantidad}} incidencias de comunicacion con el sistema TRON", "En analisis.", "SI", ""]
];
